...
### Skills
![skills](https://skillicons.dev/icons?theme=light&perline=8&i=linux,ubuntu,py,bash,ts,js,html,css,anaconda,jquery,nodejs,yarn,npm,django,flask,react,vue,sass,docker,aws,git,github,githubactions")
